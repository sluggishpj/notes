import BinarySearchTreeNode from '@/algorithm/data-structure/tree/binary-search-tree/BinarySearchTreeNode'
...
describe('BinarySearchTreeNode', () => {
  ...
  it('测试remove', () => {
    ...
    expect(rootNode.value).toBe(15)
    expect(rootNode.right.value).toBe(20)
    expect(rootNode.right.left.value).toBe(17)
  })
})
